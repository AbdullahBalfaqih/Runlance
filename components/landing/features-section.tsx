...
const features = [
  {
    ...
    description: "Get instant AI analysis of job fit. See exactly how your skills match the role with a detailed compatibility score and actionable insights.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI Interview Coach",
    description: "Practice with our AI coach powered by realistic interview scenarios. Get real-time feedback and improve your answers before the real interview.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Resume Optimization",
    description: "Tailor your resume instantly. AI automatically highlights relevant skills and experiences that match your target role.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Career Analytics",
    description: "Track your progress with detailed analytics. See trends, identify gaps, and get personalized recommendations to advance faster.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">Better prepared.</span>
          </h2>
        </div>
